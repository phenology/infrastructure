...
To install extra libraries the user should read [Emma's Ansible add new modules](https://github.com/nlesc-sherlock/emma/blob/master/ansible.md#add-new-modules) and follow the [example notebooks](notebooks/examples) named **extra_libraries**.ipynb under each language.
